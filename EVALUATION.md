...
That shift is what this challenge tries to measure. It does not measure typing speed, framework familiarity, or how many bugs you can fix in an hour. It measures judgment.
...
In this challenge: when you fix a bug or add a feature, do you notice when your change crosses a seam? Do you name the seam? Do you propose a clean shape for it, or do you patch the symptom?
...
Did you stop when the test passed, or when the behavior in the browser was actually right? Did you run the dashboard yourself and click through it? Did you update the docs you changed? When you found one bug, did you ask whether the same class of problem exists elsewhere?
...
We deliberately under-specify some things. We don't tell you exactly which bugs to find or exactly what shape the feature should take. We want to see what you do with that.
...
- **Whether you finished everything.** A polished fix-of-two-bugs with a clear decision log beats a sloppy fix-of-three-bugs with no writing. Quality > quantity.
...
- **Bug fixes that paper over the symptom without naming the cause.** If you wrap a query in a try/catch to silence an error, tell us in the decision log that you knew you were doing that and what the real fix would be.
...
If your submission moves forward, we'll set up a **60-minute technical conversation**. It is not a coding interview. It is a discussion about the choices you made: which bug you tackled first and why, how you used AI for which parts, what you'd do differently with more time, and one or two past-tense behavioral questions about production systems you've owned.
